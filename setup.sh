...
# Версия: Идеальная (Красивые имена интерфейсов и зон)
# =================================================================
...
start() {
    ...
    if [ ! -d "/sys/class/net/\$L3_DEV" ]; then
        ...
        # Не возвращаем ошибку сразу, даем hotplug шанс поднять правила позже
    fi
...
echo "вставьте ваши ключи и IP-адрес сервера."м
